...
class AssignSkeleton(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if self.seqType=="combine":
            ...
            bpy.context.scene.objects.active = Selected_Meshes[MeshIndx]
            obj = bpy.context.active_object
            for v in obj.data.vertices:
            ...
            bpy.context.scene.objects.active = Selected_Meshes[SkelIndx]
            obj = bpy.context.active_object
            for v in obj.data.vertices:
                V.append(list(obj.matrix_world*v.co))
            for e in obj.data.edges:
